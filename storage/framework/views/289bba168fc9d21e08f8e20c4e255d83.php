<?php $__env->startSection('title', 'Calling CRM User Report'); ?>
...
<div class="calling-crm-canvas"><main class="crm-page-main">
  ...
  <div class="top-content">
    <button class="back-btn" onclick="window.location='<?php echo e(route('admin_panel.admin.callingcrm.report')); ?>'" title="Go back">
...
<script src="<?php echo e(asset('js/crm/pages/user-report.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views/admin_panel/callingcrm/user-report.blade.php ENDPATH**/ ?>