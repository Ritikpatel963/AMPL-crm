<?php $__env->startSection('title', 'Add Vendor Category'); ?>
...
<div class="card shadow-sm rounded-3 border-0 p-4">
    ...
    <form action="<?php echo e(route('admin_panel.admin.vendor_categories.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g., Vegetables, Fruits" required>
...
<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\admin_panel\vendor_categories\create.blade.php ENDPATH**/ ?>