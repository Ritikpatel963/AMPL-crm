...
<div class="card shadow-sm border-0 rounded-3 p-4">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            ...
            <td>#ORD<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?></td>
            <td>
                <?php if(isset($order->product_name)): ?>
                    <?php echo e($order->product_name); ?>

                <?php elseif(isset($order->items) && count($order->items)): ?>
                    <?php echo e($order->items[0]->product->name); ?>
            ...
            <td class="text-center">
                <button class="btn btn-outline-primary btn-sm edit-btn" data-id="<?php echo e($order->id); ?>" data-status="<?php echo e($order->status); ?>">
                    <i class="bi bi-pencil-square"></i>
                </button>
                <button class="btn btn-outline-danger btn-sm delete-btn" data-id="<?php echo e($order->id); ?>">
...
<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\admin_panel\orders\index.blade.php ENDPATH**/ ?>