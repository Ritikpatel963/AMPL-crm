<?php $__env->startSection('title', 'Calling CRM Report'); ?>
...
<main class="crm-page-main"
    data-default-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.user')); ?>"
    data-activity-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.user_activity')); ?>"
    data-lead-disposition-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.lead_disposition')); ?>"
    data-user-stage-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.user_stage')); ?>"
    data-login-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.login')); ?>"
    data-follow-up-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.follow_ups')); ?>"
    data-campaign-report-url="<?php echo e(route('admin_panel.admin.callingcrm.report.campaign')); ?>"
>
...
<script src="<?php echo e(asset('js/crm/pages/report.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views/admin_panel/callingcrm/report.blade.php ENDPATH**/ ?>