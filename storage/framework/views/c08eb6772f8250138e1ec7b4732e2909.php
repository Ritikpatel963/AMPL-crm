<?php $__env->startSection('title', 'Hourly & Login Report'); ?>
...
<div class="calling-crm-canvas login-report-page" data-report-login-endpoint="reports/login" data-report-hourly-endpoint="reports/hourly" data-report-day-endpoint="reports/day">
  <div class="login-title-row">
    <button type="button" class="login-back-btn" onclick="window.location='<?php echo e(route('admin_panel.admin.callingcrm.report')); ?>'" aria-label="Back to reports">
...
<script src="<?php echo e(asset('js/crm/pages/login-report.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\admin_panel\callingcrm\login-report.blade.php ENDPATH**/ ?>