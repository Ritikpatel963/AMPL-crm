<div class="bulk-actions-wrapper">
        ...
        <?php if($showDropdown): ?>
            <div class="bulk-actions-dropdown" wire:click.outside="toggleDropdown">
                ...
                <button 
                    ...
                    onclick="return confirm('Are you sure you want to delete <?php echo e(selectedCount); ?> leads?')"
                >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <button 
                    ...
                    onclick="return confirm('Are you sure you want to close <?php echo e(selectedCount); ?> leads?')"
                >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <?php if($selectedCount > 0): ?>
        <div class="selected-count">
            <span><?php echo e($selectedCount); ?> lead<?php echo e($selectedCount !== 1 ? 's' : ''); ?> selected</span>
        </div>
    <?php endif; ?>
</div>
...
</style><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\livewire\bulk-actions.blade.php ENDPATH**/ ?>