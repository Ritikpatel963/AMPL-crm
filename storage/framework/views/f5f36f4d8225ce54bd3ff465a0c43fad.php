<?php $__env->startSection('title', 'Edit Vendor Category'); ?>
...
<div class="card shadow-sm rounded-3 border-0 p-4">
    ...
    <form action="<?php echo e(route('admin_panel.admin.vendor_categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="slug" name="slug" value="<?php echo e(old('slug', $category->slug)); ?>" placeholder="Auto-generated">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="alert alert-info mt-3">
            <strong>Info:</strong>
            <ul class="mb-0 mt-2">
                <li>Subcategories: <strong><?php echo e($category->children()->count()); ?></strong></li>
                <li>Associated Vendor Products: <strong><?php echo e($category->vendorProducts()->count()); ?></strong></li>
            </ul>
        </div>
        ...
        <div class="mt-4">
            ...
            <a href="<?php echo e(route('admin_panel.admin.vendor_categories.index')); ?>" class="btn btn-secondary ms-2">
...
<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\admin_panel\vendor_categories\edit.blade.php ENDPATH**/ ?>