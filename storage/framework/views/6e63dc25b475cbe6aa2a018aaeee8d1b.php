                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="menu-callingcrm">
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.dashboard')); ?>">Dashboard</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.contacts.index')); ?>">Contacts</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.contacts.create')); ?>">Add Lead</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.contacts.upload')); ?>">Upload Excel</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.pipeline.index')); ?>">Pipeline</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.reports.index')); ?>">Reports</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('callingcrm.trends.index')); ?>">Trends</a></li>
                        </ul>
                    </li>
                    <li class="collapsed">
...
<?php /**PATH E:\allproject\ampl_crm_project_new\AMPL-crm\resources\views/admin_panel/layout/app.blade.php ENDPATH**/ ?>