...
<?php $__env->startSection('main-content'); ?>
                ...
                <form method="GET" action="<?php echo e(route('callingcrm.trends.index')); ?>" class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="range" class="form-select">
                            <option value="30_days" <?php if($activeFilter === '30_days'): echo 'selected'; endif; ?>>Last 30 Days</option>
                            <option value="7_days" <?php if($activeFilter === '7_days'): echo 'selected'; endif; ?>>Last 7 Days</option>
                            <option value="custom" <?php if($activeFilter === 'custom'): echo 'selected'; endif; ?>>Custom Range</option>
                        </select>
                    </div>
                    <div class="col-md-4">
    ...
    <div class="card crm-soft-card p-4 mt-4">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $userTrend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <div class="crm-chart-row">
                <div class="crm-chart-label"><?php echo e($item['name']); ?></div>
                <div class="crm-chart-track">
                    <div class="crm-chart-fill" style="width: <?php echo e(round(($item['calls'] / $maxUserCalls) * 100)); ?>%;"></div>
                </div>
                <div class="crm-chart-value"><?php echo e($item['calls']); ?></div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views/callingcrm/trends/index.blade.php ENDPATH**/ ?>