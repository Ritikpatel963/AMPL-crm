...
<div class="card shadow-sm rounded-3 border-0 p-4">
    ...
    <form action="<?php echo e(route('admin_panel.admin.categories.update', $category->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="alert alert-info mt-3">
            ...
            <ul class="mb-0 mt-2">
                ...
                <li>Associated Products: <strong><?php echo e($category->vendorProducts()->count()); ?></strong></li>
            </ul>
        </div>
...
<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\admin_panel\categories\edit.blade.php ENDPATH**/ ?>