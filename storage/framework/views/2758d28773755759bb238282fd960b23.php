    ...
    <div style="overscroll-behavior: none;">
        ...
        <div class="fixed w-full h-16 pt-2 text-white flex items-center justify-between shadow-md px-3"
            ...
            <div class="flex items-center space-x-3">
                ...
                <!-- Profile Picture -->
                <img src="<?php echo e($user->profile_photo_url ?? asset('default-avatar.png')); ?>" alt="DP"
        ...
        <div class="mt-20 mb-20 px-4"
            ...
            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($message['type'] === 'product'): ?>
                    <!-- PRODUCT BUBBLE -->
                    <div
                        class="flex <?php echo e($message['sender'] != auth()->user()->name ? 'justify-start' : 'justify-end'); ?> my-2">
                        <div class="px-4 py-2 rounded-2xl shadow text-right"
                            ...
                            <b>You: </b>
                            <img src="/<?php echo e($message['data']['image']); ?>" class="rounded-lg mb-2"
                                style="width:100%; height:150px; object-fit:cover;">

                            <div class="font-bold text-gray-800">
                                <?php echo e($message['data']['name']); ?>

                            </div>
                            <div class="text-primary font-semibold">
                                Rs <?php echo e($message['data']['price']); ?>
                    ...
                    <?php if($message['sender'] != auth()->user()->name): ?>
                        <div class="flex justify-start my-2">
                            <div class="px-4 py-2 rounded-2xl shadow"
                                ...
                                <b><?php echo e($message['sender']); ?>:</b> <?php echo e($message['message']); ?>

                                <div class="text-xs text-gray-600 mt-1 text-right"><?php echo e($message['time']); ?></div>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="flex justify-end my-2">
                            <div class="px-4 py-2 rounded-2xl shadow text-right"
                                style="background-color:#b3d1ff; color:#000; max-width:70%; word-wrap:break-word;">
                                <b>You: </b><?php echo e($message['message']); ?>

                                <div class="text-xs text-gray-700 mt-1"><?php echo e($message['time']); ?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo $__env->make('components.product-slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
</div><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\livewire\chat-component.blade.php ENDPATH**/ ?>