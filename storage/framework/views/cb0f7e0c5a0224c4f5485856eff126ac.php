        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li><a class="m-link <?php echo e($isAdminMenu ? 'active' : ''); ?>" href="<?php echo e(route('admin_panel.admin.admins.index')); ?>"><i
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse<?php echo e($isProductMenu ? ' show' : ''); ?>" id="menu-product_p">
                            ...
                            <li><a class="ms-link" href="<?php echo e(route('admin_panel.admin.products.create')); ?>">Add
                                    Products</a></li>
                            <li><a class="ms-link" href="<?php echo e(route('admin_panel.admin.product_attributes.index')); ?>">Attributes</a></li>
