...
<?php $__env->startSection('title', 'Rejected Kyc'); ?>

<?php $__env->startSection('main-content'); ?>
<div class="card shadow-sm border-0 rounded-3 p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-bold">KYC Rejected Vendors</h5>
        <span class="badge bg-danger fs-6"><?php echo e($vendors->count()); ?> Rejected</span>
    </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-primary btn-sm"
                            onclick="openReApproveModal(<?php echo e($vendor->id); ?>, '<?php echo e($vendor->name); ?>')">
...
<?php echo $__env->make('admin_panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website-project\Amplchat\CMS\resources\views\admin_panel\kyc\rejected.blade.php ENDPATH**/ ?>