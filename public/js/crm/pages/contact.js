...
const openUploadModal = document.querySelectorAll('[data-upload-open]');
...
const openLeadModal = document.querySelectorAll('[data-lead-open]');
...
function bindSingleContactModal(modal, openButton, closeButtons) {
  if (modal && openButton) {
