...
<body>
    <div class="card">
        ...
        <form method="POST" action="{{ route('admin_panel.admin.settings.update') }}">
            @csrf
            <label>
                <input type="checkbox" name="google_login_enabled" value="1" {{ $googleLoginEnabled ? 'checked' : '' }}>
                Enable Google Login
            </label>
            <br><br>
        ...
        <br>
        <a href="{{ route('admin_panel.admin.index') }}">Back to Dashboard</a>
    </div>
</body>
</html>
