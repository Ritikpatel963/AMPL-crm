  ...
  <div class="dashboard-grid">
    ...
    <div class="card tools-card">
      ...
      <div class="tools-grid">
        <a class="tool-item" href="{{ route('admin_panel.admin.callingcrm.trends') }}">
        ...
        <a class="tool-item" href="{{ route('admin_panel.admin.callingcrm.pipeline') }}">
          <div class="tool-icon-wrap">⚡</div>
          <div class="tool-info">
    ...
    <div class="card quick-card">
      ...
      <div class="quick-grid">
        <a class="quick-item" href="{{ route('admin_panel.admin.callingcrm.report.user') }}">
          <div class="quick-icon">📞</div>
          <span class="quick-label">User Call Report</span>
          <span class="quick-arrow">›</span>
        </a>
        <a class="quick-item" href="{{ route('admin_panel.admin.callingcrm.report.login') }}">
          <div class="quick-icon">🔐</div>
    ...
    <div class="card pinned-section">
      <div class="pinned-header">
        ...
        <div class="pinned-actions">
          <a href="{{ route('admin_panel.admin.callingcrm.report') }}" class="report-link">Campaigns Report</a>
      ...
      <div class="view-all-link">
        <a href="{{ route('admin_panel.admin.callingcrm.pipeline') }}">View All Campaigns &rsaquo;</a>
      </div>
    </div>
