...
<div class="card shadow-sm rounded-3 border-0 p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin_panel.admin.categories.create') }}" class="btn btn-primary">
    ...
    <table class="table table-striped table-hover align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admin_panel.admin.categories.edit', $category->id) }}" class="btn btn-warning btn-sm">
                        <i class="bi bi-pencil"></i> Edit
                    </a>
                    <form action="{{ route('admin_panel.admin.categories.destroy', $category->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
